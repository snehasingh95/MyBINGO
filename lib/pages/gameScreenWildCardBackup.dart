...
import 'package:my_bingo/widgets/wildCardWidget.dart';
...
class _GameScreenState extends State<GameScreen> {
  ...
  TextButton getWildCardButton() {
    return TextButton(
      onPressed: () {
        showDialog(
          context: context,
          builder: (context) => WildCardWidget(
              wildCard: WildCard(
            title: "Spin",
            description: "Spin the grid Clockwise",
            action: ActionService.spin,
            arguments: {
              "tiles": grid.tiles,
              "n_col": grid.n_col,
              "clockwise": true,
